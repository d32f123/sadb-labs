...
@Slf4j
public class PersonProjectLinkGenerator extends AbstractEntityGenerator<PersonProjectLink> {

    public PersonProjectLinkGenerator(Set<DependencyDefinition> dependencies, Generator generator) {
